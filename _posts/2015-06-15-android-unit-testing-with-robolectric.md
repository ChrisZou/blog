...
记得第一份工作在创新工场的时候，听当时的boss @王明礼 说，公司有个神级的程序员（。。。名字忘了。。。），他会写大量的单元测试，甚至达到50%。当时崇拜之极，却仍然觉得写单元测试是很麻烦的一件事情。话说回来，当时还给公司写了一套测试框架，但是只用来跑monkey，因为没人写单元测试，所以也就没有加上跑单元测试的逻辑。。。    
扯远了，话说回来，当你接触多了国外的博客，视频之后，你会发现，单元测试甚至TDD，在国外是非常流行的事情。很多人甚至说离开了单元测试，他们便没有办法写代码。这些都让我对单元测试的好感度逐渐的上升。然而，真正让我下定决心，一定要研究一下这个东西的，是前段时间看大名鼎鼎的《重构：改善现有代码的艺术》里面有一段话：    
...
是的，你没看错，他说单元测试可以节约时间，提高开发速度！！！身为一个无可救药的懒癌患者，看了这句话简直就像看到了一道神光似的！    
...
Martin Fowler在《重构》里面还解释了为什么单元测试可以节省时间，大意是我们写一个程序，其实大部分时间不是花在写代码上面，而是花在debug上面，是花在找出问题到底出在哪上面，而单元测试可以最快的发现你的代码哪里不work，这也可以在很大程度上防止regression（相信QE和QA们一定很喜欢哈哈。。。），which我觉得是个大部分程序员都很头疼的问题。    
